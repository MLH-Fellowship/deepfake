...
from ml.modules.util import AntiAliasInterpolation2d, make_coordinate_grid
...
class DiscriminatorFullModel(torch.nn.Module):
    ...
    def forward(self, x, generated):
        ...
        for scale in self.scales:
            key = 'prediction_map_%s' % scale
            value = (
                1 - discriminator_maps_real[key]) ** 2 + discriminator_maps_generated[key] ** 2
            value_total += self.loss_weights['discriminator_gan'] * \
                value.mean()
