import sys
import os
from ml.animate import animate
from ml.reconstruction import reconstruction
from ml.train import train
import torch
from ml.modules.keypoint_detector import KPDetector
from ml.modules.discriminator import MultiScaleDiscriminator
from ml.modules.generator import OcclusionAwareGenerator
from ml.frames_dataset import FramesDataset
...
if __name__ == "__main__":
    ...
    if opt.mode == 'train':
        print("Training...")
        train(config, generator, discriminator, kp_detector,
              opt.checkpoint, log_dir, dataset, opt.device_ids)
    elif opt.mode == 'reconstruction':
        print("Reconstruction...")
        reconstruction(config, generator, kp_detector,
                       opt.checkpoint, log_dir, dataset)
    elif opt.mode == 'animate':
        print("Animate...")
        animate(config, generator, kp_detector,
                opt.checkpoint, log_dir, dataset)
